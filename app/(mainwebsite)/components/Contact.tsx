...
export default function ContactFormWithSocialButtons() {
  ...
  if (state.succeeded) {
    return (
      <Box textAlign="center" py={"300px"} px={6}>
        ...
        <Button my={6} onClick={(e) => {e.preventDefault();window.location.href='/'}}>
          Go to home page
        </Button>
      </Box>
    );
  ...
  return (
    <Flex
      ...
      justify="center"
      css={{
        backgroundImage: colorMode === "light" ? CONFETTI_LIGHT : CONFETTI_DARK,
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              ...
              >
                ...
                <Box as="a" href="https://github.com/seanmic1">
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Box as="a" href="https://www.linkedin.com/in/seanmic1/">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
