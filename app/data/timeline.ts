...
export const timeline: TimelineNode[] = [
  ...
  },
  {
    ...
    org: "Qashier · Engineering",
    place: "Kuala Lumpur, Malaysia",
    peek: "Access control across every Qashier platform — who gets in, and what they are allowed to touch.",
    body: [
      "Access control systems across all of Qashier's platforms: tightening the security model, and making IAM something that can actually be managed concisely — internally, and with the merchants running on us.",
